...
/**
 * An {@link ActionWithData} that configures an AEM component. Consumes
 * {@link ConfigureComponentData}.
 */
@PageObject
public class ConfigureComponentAdobeClassic implements ActionWithData<ConfigureComponentData> {
	...
	@Global
	@FindPageObject
	private ConfigDialogAdobeClassic configDialog;
	...
	public void execute(ConfigureComponentData data) {
		...
		ComponentConfiguration componentConfiguration = componentConfigReader
				.readConfiguration(data.getConfigLocation());
